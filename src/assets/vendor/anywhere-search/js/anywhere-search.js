  ...
  $(document).ready(function () {
      ...
      $('[data-pages="search"]').search({
          ...
          onSearchSubmit: function (searchString) {
              clickbutton(searchString.split(' ')[0]);
              window.location = "/anzsco/" + searchString.split(' ')[0];
              //console.log("Search for: " + searchString);
          },
          //onClick: function (searchString) {
...
(function ($) {
  ...
  function Plugin(option) {
      return this.each(function () {
          $('.main-wrap').removeClass('main-wrap--move');
          var $this = $(this);
...
(function ($) {
  ...
  Search.prototype.init = function () {
      ...
      this.$element.on('click', function (e) {
          _this.options.onClick && _this.options.onClick(_this.$searchField.val());
...
document.documentElement.className = 'main-wrap-search';
